                    ...
                    <div class="row">
                        ...
                        <nav class="navbar navbar-expand-lg narbar-light">
                            ...
                            <a class="navbar-brand mr-auto" href="#">
                                <img src="img/logo_bpbd.png"  alt="Site logo">

                            </a></div>
                            <div class="col-3 "><h1 class="judul">Badan Penanggulangan Kabupaten Ciamis</h1></div>
                            <div class="col-7"><button type="button" id="nav-toggle" class="navbar-toggler collapsed" data-toggle="collapse" data-target="#mainNav" aria-expanded="false" aria-label="Toggle navigation">
                            ...
                            <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                                <ul class="navbar-nav ml-auto">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-4">statistik</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-5">maps</a>
                                  </li>
                                  {{-- <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-6"></a>
                                  </li> --}}
                                </ul>
                            </div></div>
                                ...
                                <form action="index.html" method="get" class="tm-search-form tm-section-pad-2">
                                    {{-- <div class="form-row tm-search-form-row">
                                        ...
                                        <div class="form-group tm-form-element tm-form-element-50">
                                            ...
                                            <input name="check-in" type="text" class="form-control" id="inputCheckIn" placeholder="tanggal">
                                        </div>
                                        <div class="form-group tm-form-element tm-form-element-50">
                                            <i class="fa fa-calendar fa-2x tm-form-element-icon"></i>
                                    ...
                                    <div class="form-row tm-search-form-row">
                                        <div class="form-group tm-form-element tm-form-element-2">
                                            ...
                                            <i class="fa fa-2x fa-map-marker tm-form-element-icon"></i>
                                        </div>
                                        <div class="form-group tm-form-element tm-form-element-2">
                                            ...
                                            <i class="fa fa-calendar tm-form-element-icon tm-form-element-icon-small"></i>
                                        </div>
                                        <div class="form-group tm-form-element tm-form-element-2">
                                            <select name="room" class="form-control tm-select" id="room">
                                                <option value="">Jenis Bencana Alam</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                                <option value="4">4</option>
                                        ...
                                        <div class="form-group tm-form-element tm-form-element-2">
                                            <button type="submit" class="btn btn-primary tm-btn-search">Filter</button>
                                        </div>
                                      </div>
